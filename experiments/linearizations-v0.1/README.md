...
- `amendment-1.json` to `amendment-6.json`: the changes made after the
  ...
  merged, with the first count's table recorded in the amendment; and two
  platform-independence fixes to the check (module order, logarithm noise);
